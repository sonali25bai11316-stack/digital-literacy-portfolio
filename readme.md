...
Course Code: CSE001 (Digital Literacy) 
report_Project_Report.pdf None
...
This task helped in building a strong online professional presence.

Task 3 – Coding & Collaboration Platforms
Practiced coding on HackerRank
Created a Google Form quiz on digital literacy
https://docs.google.com/forms/d/e/1FAIpQLSceJzqhmKflUMvIErbEZB3sCRrsmxRNCAsNs57UlE5P4hrblQ/viewform?usp=publish-editor
Analyzed responses using Google Sheets
Enhanced both technical and collaboration skills.

Task 4 – Professional Email & Etiquette
Wrote professional emails (internship & extension request)
Learned importance of tone, structure, and clarity
Created social media communication guidelines
